...
<div class="modal-content">
  <div class="modal-header">
    <h2 class="modal-title" id="exampleModalLabel">Entrer votre email pour ne pas manquer la publication de notre nouveau post !</h2>
