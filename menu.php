<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-163411784-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-163411784-1');
    </script>
    <script data-ad-client="ca-pub-8679914437126860" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
  </head>
